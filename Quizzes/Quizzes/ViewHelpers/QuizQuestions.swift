...
class QuizQuestions: UICollectionViewCell {
    ...
    func optionButtonsConstrant(){
            ...
            optionButtons.heightAnchor.constraint(equalTo: heightAnchor, multiplier: 0.2).isActive = true
            optionButtons.widthAnchor.constraint(equalTo: widthAnchor, multiplier: 0.2).isActive = true
    }
}
